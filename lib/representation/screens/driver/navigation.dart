...
import 'package:nbtour/utils/helper/map_util.dart';
import 'package:vietmap_flutter_navigation/embedded/controller.dart';
import 'package:vietmap_flutter_navigation/helpers.dart';
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        onPressed: () async {
          ...
          MapUtils.openMap(widget.wayPoints[index].latitude!,
              widget.wayPoints[index].longitude!);
        },
        child: Align(
          alignment: AlignmentDirectional.centerStart,
          child: Text(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SafeArea(
        ...
        child: Stack(
          children: [
            ImageHelper.loadFromAsset(AssetHelper.mapImage,

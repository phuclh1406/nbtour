      ...
      child: Stack(
        children: [
            ...
            child: IconButton(
                ...
                icon: Container(
                  decoration: const BoxDecoration(
                      color: Colors.white,
                      borderRadius:
                          BorderRadius.all(Radius.circular(kMediumPadding))),
                  child: IconButton(
                      onPressed: () {
                        Navigator.of(context).pop();
                      },
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  tour.tourRoute!.routeSegment![0]
                                      .segmentDepartureStation!.stationName!,
                              ...
                              children: [
                                ...
                                Text(
                                  DateFormat.yMMMd().format(
                                      DateTime.parse(tour.departureDate!)),
                                  style: const TextStyle(fontSize: 18),
                                ),
                              ],
                            ),
                              ...
                              children:
                                ...
                                return Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      color:
                                          const Color.fromARGB(30, 255, 89, 0)),
                                  child: Padding(
          ...
          Positioned(
            ...
            right: 0,
            child: Container(
              width: MediaQuery.of(context).size.width - kDefaultIconSize,

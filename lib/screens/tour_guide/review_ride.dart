...
class _ReviewRideTourGuideScreenState extends State<ReviewRideTourGuideScreen> {
  ...
  // void checkPoiForVoiceNotification() async {
  //   var location = await Geolocator.getCurrentPosition();
  //   for (var i = 0; i < pointList!.length; i++) {
  //     double distance = Geolocator.distanceBetween(
  //         double.parse(pointList![i].latitude!),
  //         double.parse(pointList![i].longitude!),
  //         location.latitude,
  //         location.longitude);
  //     print(pointList);
  //     if (distance <= 100) {
  //       player.stop();
  //       await player.setUrl(pointList![i].poiSound![0].file!);
  //       player.play();
